...
private:
	...
	bool CheckFloor2Capsule(CapsuleCollider* cap, int f, float _dt);
	bool CheckCapsule(GameObject* tg, int _min, int _max, CapsuleCollider* cap, Capsule c, float3 vel, int f, float _dt);
	bool CheckFloor2Sphere(SphereCollider* sphere, int f, float _dt);
	bool CheckSphere(GameObject* tg, int _min, int _max, SphereCollider* sphere, Sphere s, float3 vel, int f, float _dt);
